...
func main() {
	...
	teamService := service.NewTeamService(pgRepo, wp)
	...
	hackathonService := service.NewHackathonService(pgRepo, cache, wp)
	judgeService := service.NewJudgeService(pgRepo)
	superAdminService := service.NewSuperAdminService(pgRepo, wp)
